...
public class TilemapVisualizer : MonoBehaviour
{
    ...
    [SerializeField] private TileBase wallTop, wallSideRight, wallSideLeft, wallBottom, wallFull, 
        wallInnerCornerDownLeft, wallInnerCornerDownRight, wallInnerCornerTopRight, wallInnerCornerTopLeft, 
        wallDiagonalCornerDownRight, wallDiagonalCornerDownLeft, wallDiagonalCornerUpRight, wallDiagonalCornerUpLeft;

    public void PaintFloorTiles(IEnumerable<Vector2Int> floorPositions)
    {
        //PaintTiles(floorPositions, floorTilemap, floorTiles[Random.Range(0,floorTiles.Length)]);
    ...
    internal void PaintSingleCornerWall(Vector2Int position, string binaryType)
    {
        ...
        if (WallTypesHelper.wallInnerCornerTopLeft.Contains(typeASInt))
        {
